...
abstract class Interceptor {
  ...
  FutureOr<AxiosResponse<dynamic>> onResponse(AxiosResponse<dynamic> response) => response;
...
class InterceptorManager {
  ...
  Future<AxiosResponse<dynamic>> processResponse(AxiosResponse<dynamic> response) async {
